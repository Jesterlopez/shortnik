    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <nav className={styles.navegation}>
          <ul className={styles.navegationItems}>

            <li>
              <Link href="/">
              <a className={styles.navigationLogo}>Shortnik</a>
              </Link>
              </li>
            <li className={styles.navigationGithub}>
              <Link href="#">
                <a>
        ...
        <h1 className={styles.title}>Shortnik</h1>

        <p className={styles.description}>
          Paste and get a shorter url, ready to share on your social networks.
        </p>
